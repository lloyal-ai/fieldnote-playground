...
> **Lineage.** Evolved from reasoning.run 0.8.0's RACE/DRB-tuned pipeline —
> a real, editable starter, not a dependency. Its document model is its own;
> the design record is `docs/document-identity.md`.
